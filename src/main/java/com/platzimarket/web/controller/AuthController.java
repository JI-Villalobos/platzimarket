...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createTolken(@RequestBody AuthenticationRequest request){
       try {
           authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(request.getUsername(), request.getPassword()));
           UserDetails userDetails = platziUsersDetailsService.loadUserByUsername(request.getUsername());
